                            ...
                            <div key={product.id} className="glass-card group hover:border-accent/30 transition-all duration-300">
                                ...
                                <div className="p-8 space-y-6">
                                    <div className="space-y-2">
                                        ...
                                        <h3 className="text-xl font-black italic uppercase tracking-tight group-hover:text-accent transition-colors underline decoration-transparent group-hover:decoration-accent/30">
                                            {product.name}
                                        </h3>
                                    ...
                                    <div className="grid grid-cols-2 gap-3 pt-2">
                                        <button className="flex items-center justify-center gap-2 p-4 bg-white border border-border/50 rounded-xl text-[10px] font-black uppercase tracking-widest hover:bg-muted transition-all">
                                            <Edit2 size={12} /> Edit
                                        </button>
                                        <button className="flex items-center justify-center gap-2 p-4 bg-red-500/5 border border-red-500/10 text-red-500 rounded-xl text-[10px] font-black uppercase tracking-widest hover:bg-red-500 hover:text-white transition-all">
