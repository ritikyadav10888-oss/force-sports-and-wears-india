            ...
            <div className="flex flex-col md:flex-row md:items-center justify-between gap-6">
                ...
                <div className="flex items-center gap-3">
                    <select
                        ...
                        disabled={updating}
                        className="px-6 py-4 bg-secondary text-foreground border border-border/50 rounded-2xl font-black uppercase tracking-widest text-[10px] focus:outline-none focus:ring-2 focus:ring-accent/50 outline-none disabled:opacity-50 cursor-pointer hover:border-accent/50 transition-colors"
                    >
