    ...
    return (
        <div className="group bg-secondary/50 backdrop-blur-sm rounded-3xl p-8 border border-border/50 
            ...
            <div className="flex items-start justify-between mb-8">
                ...
                {trend && (
                    <div className={`px-4 py-2 rounded-full text-[10px] font-black uppercase tracking-[0.15em] border ${trend.isPositive
            ...
            <div className="space-y-3">
                ...
                <p className="text-5xl font-black italic tracking-tighter leading-none gradient-text">
                    {value}
                </p>
            </div>
        </div>
